...
export async function renderKpiCards(scope, value, cargoType) {
  ...
  container.innerHTML = `
    ...
    <div class="kpi-card"><div class="kpi-value">${formatArea(data.terminal_area_sqm)}</div><div class="kpi-label">Terminal Area</div></div>
    <div class="kpi-card"><div class="kpi-value">${formatArea(data.berth_area_sqm)}</div><div class="kpi-label">Berth Area</div></div>
