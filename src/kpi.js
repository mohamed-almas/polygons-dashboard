...
export async function renderKpiCards(scope, value) {
  ...
  container.innerHTML = `
    ...
    <div class="kpi-card"><div class="kpi-value">${formatCompact(data.given_port_area_sqm)}</div><div class="kpi-label">Given port area (sqkm)</div></div>
    <div class="kpi-card"><div class="kpi-value">${formatCompact(data.physical_area_sqm)}</div><div class="kpi-label">Physical area (sqkm)</div></div>
    <div class="kpi-card"><div class="kpi-value">${formatCompact(data.estimated_area_sqm)}</div><div class="kpi-label">Estimated port area (sqkm)</div></div>
